...
class VeiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veiculo" do
    assert_difference("Veiculo.count") do
      post veiculos_url, params: { veiculo: { ano: @veiculo.ano, chassi: @veiculo.chassi, cor: @veiculo.cor, modelo: @veiculo.modelo, placa: @veiculo.placa, quilometragem: @veiculo.quilometragem } }
    end
